---
title: "Rank-Sorting: Dimensionality Reduction of Motion Features with Linear Optimal Low Rank Projection (LOL)"
...
temp_var<-lapply(temp_var, function(x) t(apply(x,1,sort,decreasing = TRUE)))
