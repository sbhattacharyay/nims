---
title: "Time-Sorting: Dimensionality Reduction of Motion Features with Linear Optimal Low Rank Projection (LOL)"
...
band_powerLOL_GOSE_kfold <- lol.xval.eval(band_powerFeats, Y, r, alg = lol.project.lol, alg.return="A", classifier=MASS::lda, classifier.return="class", k=5)
...
data <- data.frame(x1=band_powerLOL_GOSE_kfold$model$Xr[,1], x2=band_powerLOL_GOSE_kfold$model$Xr[,2], y=PYpatient_table$GOSE)
...
ggplot(data, aes(x=x1, y=x2, color=y)) +
  ...
  ylab("Projection 2") +
  labs(color = "GOSE_dis") + 
  ggtitle(sprintf("Band Power GOSE 5 fold, L=%.2f", band_powerLOL_GOSE_kfold$lhat))
...
data <- data.frame(x1=freq_entropyLOL_GOSE_kfold$model$Xr[,1], x2=freq_entropyLOL_GOSE_kfold$model$Xr[,2], y=PYpatient_table$GOSE)
data$y <- factor(data$y)
ggplot(data, aes(x=x1, y=x2, color=y)) +
  geom_point() +
  xlab("Projection 1") +
  ylab("Projection 2") +
  labs(color = "GOSE_dis") +
  ggtitle(sprintf("Freq Entropy GOSE 5 fold, L=%.2f", freq_entropyLOL_GOSE_kfold$lhat))
...
data <- data.frame(x1=freq_pairsLOL_GOSE_kfold$model$Xr[,1], x2=freq_pairsLOL_GOSE_kfold$model$Xr[,2], y=PYpatient_table$GOSE)
data$y <- factor(data$y)
ggplot(data, aes(x=x1, y=x2, color=y)) +
  geom_point() +
  xlab("Projection 1") +
  ylab("Projection 2") +
  labs(color = "GOSE_dis") +
  ggtitle(sprintf("Freq Pairs GOSE 5 fold, L=%.2f", freq_pairsLOL_GOSE_kfold$lhat))
...
data <- data.frame(x1=med_freqLOL_GOSE_kfold$model$Xr[,1], x2=med_freqLOL_GOSE_kfold$model$Xr[,2], y=PYpatient_table$GOSE)
data$y <- factor(data$y)
ggplot(data, aes(x=x1, y=x2, color=y)) +
  geom_point() +
  xlab("Projection 1") +
  ylab("Projection 2") +
  labs(color = "GOSE_dis") +
  ggtitle(sprintf("Med Freq GOSE 5 fold, L=%.2f", med_freqLOL_GOSE_kfold$lhat))
...
# data <- data.frame(x1=smaLOL_GOSE_kfold$model$Xr[,1], x2=smaLOL_GOSE_kfold$model$Xr[,2], y=PYpatient_table$GOSE)
# data$y <- factor(data$y)
# ggplot(data, aes(x=x1, y=x2, color=y)) +
#   geom_point() +
#   xlab("Projection 1") +
#   ylab("Projection 2") +
#   labs(color = "GOSE_dis") +
#   ggtitle(sprintf("SMA GOSE 5 fold, L=%.2f", smaLOL_GOSE_kfold$lhat))
...
# data <- data.frame(x1=waveletsLOL_GOSE_kfold$model$Xr[,1], x2=waveletsLOL_GOSE_kfold$model$Xr[,2], y=PYpatient_table$GOSE)
# data$y <- factor(data$y)
# ggplot(data, aes(x=x1, y=x2, color=y)) +
#   geom_point() +
#   xlab("Projection 1") +
#   ylab("Projection 2") +
#   labs(color = "GOSE_dis") +
#   ggtitle(sprintf("Wavelets GOSE 5 fold, L=%.2f", waveletsLOL_GOSE_kfold$lhat))
```
