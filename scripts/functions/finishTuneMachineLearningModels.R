finishTuneMachineLearningModels <- function(seg_window,Iter, DeepIter, classifier_choice, path.D, seed.list, labelsList) {
  ...
  for (foldIdx in 2:length(currFeatSet)){
