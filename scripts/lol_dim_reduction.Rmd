...
data <- data.frame(x1=bandPowerLOL_GOSE_kfold$model$Xr[,1], x2=bandPowerLOL_GOSE_kfold$model$Xr[,2], y=PYpatient_table$GOSE)
...
ggplot(data, aes(x=x1, y=x2, color=y)) +
  ...
  ylab("Projection 2") +
  labs(color = "GOSE_dis") + 
  ggtitle(sprintf("Band Power GOSE 5 fold, L=%.2f", bandPowerLOL_GOSE_kfold$lhat))
...
ggplot(data, aes(x=x1, y=x2, color=y)) +
  ...
  ylab("Projection 2") +
  labs(color = "GOSE_dis") +
  ggtitle(sprintf("Freq Entropy GOSE 5 fold, L=%.2f", bandPowerLOL_GOSE_kfold$lhat))
...
ggplot(data, aes(x=x1, y=x2, color=y)) +
  ...
  ylab("Projection 2") +
  labs(color = "GOSE_dis") +
  ggtitle(sprintf("Freq Pairs GOSE 5 fold, L=%.2f", freq_entropyLOL_GOSE_kfold$lhat))
...
ggplot(data, aes(x=x1, y=x2, color=y)) +
  ...
  ylab("Projection 2") +
  labs(color = "GOSE_dis") +
  ggtitle(sprintf("Med Freq GOSE 5 fold, L=%.2f", freq_pairsLOL_GOSE_kfold$lhat))
