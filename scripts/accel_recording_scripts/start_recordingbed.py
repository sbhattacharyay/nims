...
s7 = "A0:E6:F8:AE:AA:04"  #bed

classifier = []

stream7 = pexpect.spawn('gatttool -I')

log = open("logbed.txt","w")
...
def main():
        ...
        file = open("raw_databed.txt",'r')
        file_out = open("databed.txt",'w')
        for line in file:
