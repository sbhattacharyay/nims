...
band_powerFeats<-do.call(cbind,ranked_temp_var[1:6])
freq_entropyFeats<-do.call(cbind,ranked_temp_var[7:12])
freq_pairsFeats<-do.call(cbind,ranked_temp_var[13:24])
med_freqFeats<-do.call(cbind,ranked_temp_var[25:30])
smaFeats<-do.call(cbind,ranked_temp_var[31:36])
waveletsFeats<-do.call(cbind,ranked_temp_var[37:42])
