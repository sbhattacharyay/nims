...
ui <- fluidPage(
  fluidRow(
    column(12,
           h1("ICU Accelerometry Classification with Stratified 5-fold Cross-Validation")
    )
  ),
  sidebarLayout(
    sidebarPanel(
      ...
      checkboxGroupInput("mf_choice",label="Choice of Motion Features (Select at least one)",
                         choices = c(
                         ...
                         inline = FALSE),
      checkboxGroupInput("clinicalVars", label="Choice of Clinical Variables (Select at least one)",
                         choices = c(
                           "Age" = "Age",
                           "Sex" = "Sex",
                           "APACHE" = "APACHE",
    ...
    mainPanel(
      tabsetPanel(
        tabPanel("ROC 12mo",
                 ...
                 plotOutput("plot_roc_12mo", width="100%") %>% withSpinner()
        ),
        tabPanel("Precision-Recall 12mo",
                 ...
                 fluidRow(column(4,
                          ...
                          column(4,
                                 h3('Death', align = 'center'))),
                 plotOutput("plot_precrec_12mo", width = "100%")  %>% withSpinner()
        ),
        tabPanel("ROC Discharge",
                 ...
                 fluidRow(column(4,
                          ...
                          column(4,
                                 h3('Death', align = 'center'))),
                 plotOutput("plot_roc_dis", width = "100%")  %>% withSpinner()
        ), 
        tabPanel("Precision-Recall Discharge",
                 ...
                 fluidRow(column(4,
                          ...
                          column(4,
                                 h3('Death', align = 'center'))),                 
                 plotOutput("plot_precrec_dis",width="100%")  %>% withSpinner()
        ),
